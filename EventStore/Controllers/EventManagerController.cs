...
namespace EventStore.Controllers
{
    public class EventManagerController : Controller
    {
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public ActionResult Edit([Bind(Include = "EventId,TypeId,EventName,EventDescription,EventType,EventStart,EventEnd,MaxTickets,AvailableTickets,OrganizerName,Location")] Event @event)
        {
            if (ModelState.IsValid)
            {
